...
# input: state, outcome
# output: best hospital for input
best <- function(state, outcome) {
    hospital.ranks(state, outcome)[1, 1]
}

# returns the hospital name with a specified ranking for a given state and outcome
...
# input: state, rank, data with state, hospital names, and rank
# output: hospital name with the specified ranking for a given state
...
# input: hospital outcome, rank
# output: list of all states, along with the hospital name with in that state with given rank
